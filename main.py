...
# DATABASE_URL deaktiv edildi, DB funksiyaları silindi

# --- Mock funksiyalar DB yerinə ---
def get_user_language(user_id):
    return 'az'  # default dil

def is_user_blocked(user_id):
    return False  # heç kim bloklanmayıb
...
forbidden_words = [
    ...
    "gerizekalı", "oç", "kahpe", "piç", "mal", "sik", "sikik", "sikmek", "sik kafa", "oe", "amk",
    "amcik", "amcık", "orospu", "orospu evladı", "orospi", "orospu evladi", "piç", "piç kurusu", 
    "taşak", "taşşak", "çük", "götveren", "göt veren", "got veren", "yarragimin basi", "yarrağımın başı",
    "yarag", "yarak", "Блядь", "Че за галима такая?", "Мудак", "Пошел на хуй", "Блядь",
    "idiot", "dumb", "bitch", "fuck", "shit", "asshole", "bastard",
    "dick", "cunt", "motherfucker", "fucker", "damn", "bollocks",
    "ostur", "osdur", "amcıq", "dıllaq", "amk", "orospu", "sik", "sikmek", "sg", "sıçmak", "gay",
    "trans", "lezbiyen", "qozumaki", "yarram", "yala daşşağımı", "daşşağ", "peyser", "peysər", 
    "Блядь", "отвали", "дерьмо", "Сука", "Заткнись", "хуй", "пизда", "отвали",
]
...
async def blok(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # set_user_blocked deaktiv edildi
