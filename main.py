...
forbidden_words = [
    ...
    "gerizekalı", "oç", "kahpe", "piç", "mal", "sik", "sikik", "sikmek", "sik kafa", "oe", "amk", "amcik", "amcık", "orospu", "orospu evladı", "orospi", "orospu evladi", "piç", "piç kurusu", "taşak", "taşşak", "çük", "götveren", "göt veren", "göt veren", "got veren", "yarragimin basi", "yarrağımın başı",
    ...
    "ostur", "osdur", "amcıq", "dıllaq", "amk", "orospu", "sik", "sikmek", "sg", "sıçmak", "gay", "trans", "lezbiyen", "qozumaki", "yarram", "yala daşşağımı", "daşşağ", "peyser", "peysər", "Блядь", "отвали", "дерьмо", "Сука", "Заткнись", "хуй", "пизда", "отвали", 
]
